...
| --- | --- |
| **Positive** | `[POS] خوب بود کیفیتش مناسب بود و خیلی سریع به دستم رسید` |
| **Negative** | `[NEG] افتضاح بود من نمیدونم چرا شما کلا سفارش میدین` |
| **Positive** | `[POS] مثل همیشه عالی از ناتلی که خیلی راضیم` |
| **Negative** | `[NEG] جوجه‌ها کیفیت مناسبی نداشتند و سوخته بود` |
